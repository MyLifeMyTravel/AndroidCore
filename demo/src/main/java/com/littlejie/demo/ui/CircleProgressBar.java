...
import com.littlejie.demo.BuildConfig;
import com.littlejie.demo.R;

/**
 * 类似 QQ 中计步器 UI,详见：https://github.com/MyLifeMyTravel/CircleProgress
...
public class CircleProgressBar extends View {
    ...
    public void setBgArcColor(int bgArcColor) {
        mBgArcColor = bgArcColor;
    }

    public float getBgArcWidth() {
        return mBgArcWidth;
    }

    public void setBgArcWidth(float bgArcWidth) {
        mBgArcWidth = bgArcWidth;
    }
