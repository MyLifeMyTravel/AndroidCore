...
/**
 * Created by littlejie on 2017/9/22.
 */
...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void restoreState() {
        ...
        bitmap = null;
        needDraw = true;
        backgroundColor = Color.parseColor("#DD000000");
        temp = null;
    }
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                case CIRCULAR://圆形
                    temp.drawCircle(center[0], center[1], radius, circlePaint);//绘制圆形
                    break;
                case ELLIPSE://椭圆
                    //RectF对象
                    oval.left = center[0] - halfWidth;                              //左边
                    oval.top = center[1] - halfHeight;                                   //上边
                    oval.right = center[0] + halfWidth;                             //右边
                    oval.bottom = center[1] + halfHeight;                                //下边
                    temp.drawOval(oval, circlePaint);                   //绘制椭圆
                    break;
                case RECTANGULAR://圆角矩形
                    ...
                    oval.right = center[0] + halfWidth;                             //右边
                    oval.bottom = center[1] + halfHeight;                                //下边
                    temp.drawRoundRect(oval, radius, radius, circlePaint);                   //绘制圆角矩形
                    break;
            }
        } else {
            temp.drawCircle(center[0], center[1], radius, circlePaint);//绘制圆形
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (onclickListener != null) {
                    onclickListener.onClickedGuideView(GuideView.this);
                }
                if (exit) {
                    hide();
                }
